...
module SelectableInternal =
    ...
    let SelectableElem () =
        ...
        selectable.OnSelected (fun _ el ->
            el.["style"] <- "background: gray")
        selectable.OnUnselected (fun _ el ->
            el.["style"] <- "background: white")
        selectable.OnSelecting (fun _ el ->
            el.["style"] <- "background: red")
        selectable.OnUnselecting (fun _ el ->
...
type SelectableTest() = 
    ...
    [<JavaScript>]
    override this.Body = SelectableInternal.SelectableElem()
